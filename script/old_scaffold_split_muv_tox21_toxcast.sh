...
if [ $computer == dgx ]
then
    datapath=/raid/home/public/YangLiu/
    deepchem_datapath=/raid/home/public/YangLiu/DeepChem/
    tflog=/raid/home/yangliu/Molgnn_yoyo/logs/tflogs/tflogs_${experiment_repeat_id}
    device=1
fi
...
# for dataset in Tox21 ToxCast MUV
...
nohup python MoLGNN.py \
    ...
    --tflog  ${tflog}  \
    --device ${device}  \
    > ./logs/${dataset}FP_epochs${epochs}_${data_splitting_method}_${split_ratio}_${gae_train_method}_${unsupervised_training_branches}_output.log 2>&1 &
