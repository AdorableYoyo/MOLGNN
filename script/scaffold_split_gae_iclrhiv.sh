...
--tflog  ${tflog}  \
--device ${device}  > ./logs/${dataset}FP_${experiment_repeat_id}_${gae_extra_datasets}_epochs${epochs}_${data_splitting_method}_${split_ratio}_${gae_train_method}_${unsupervised_training_branches}_output.log 2>&1 &
